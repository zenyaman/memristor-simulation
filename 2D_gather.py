...
#os.chdir("/Users/sakailab/Desktop/nagata/1.27/4-elec_4V_iter=100")
os.chdir("/Users/zenyanagata/Desktop/test2")
...
def import_data():
    ...
    Nd = np.genfromtxt("Nd_iter=10000.txt", delimiter=" ")
#import_data()
